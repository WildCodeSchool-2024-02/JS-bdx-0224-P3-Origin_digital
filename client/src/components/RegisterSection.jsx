...
export default function RegisterSection() {
  ...
  return (
    ...
    id="WhySubscribe"
    ref={inViewRef}
    className={`text-center max-w-5xl lg:text-left place-self-end mt-5 lg:relative lg:px-20 lg:top-[-37vh]  ${fadeInClass}`}
>
      ...
      <p
        ref={inViewRef}
        className={`text-center max-w-xl lg:text-left  lg:relative lg:px-20 lg:top-[-37vh] lg:p-0 ${fadeInClass}`}
      >
        {isLogged
          ? "**Titre de la vidéo**"
      ...
      <Link
        to={isLogged ? " /categories/1" : "/register"}
        ref={inViewRef}
        className={`text-[var(--lightColor)] text-xl bg-[var(--primaryColor)] p-2 text-center visited:text-[var(--lightColor)] 
            ...
            lg:gap-6 lg:mb-0 lg:mr-[70vw] lg:relative lg:top-[-37vh] ${fadeInClass} whitespace-nowrap`}
      >
        <img
