...
export default function HeroSection() {
  ...
  return (
    <article
      ref={inViewRef}
      className={`bg-[url(./assets/images/banner.jpg)] 
        bg-no-repeat bg-[30%] bg-cover bg-clip-border h-[90vh] drop-shadow-lg h1-background-effect flex flex-col text-center pt-[25vh] gap-10 lg:gap-0 lg:gap-x-24 lg:grid lg:grid-cols-2 lg:grid-rows-5 lg:pt-0
        ${fadeInClass} `}
    >
      <h1
      ...
      <p className="text-[var(--lightColor)] text-xl text-center lg:text-left lg:text-2xl drop-shadow-2xl md:text-xl col-start-2 row-start-3">
        {(() => {
          if (isLogged) {
      ...
      {(() => {
        if (isLogged) {
          if (userData.role_id === 3) {
            return (
              <Link to="/dashboard" className={heroSectionButton}>
                <img
          ...
          return (
            <Link to="/categories" className={heroSectionButton}>
              <img
                src="./src/assets/images/logoPlay.png"
                alt=""
        ...
        return (
          <Link to="/register" className={heroSectionButton}>
            <img
              src="./src/assets/images/logoPlay.png"
              alt=""
              className="block w-7 h-7 md:w-6 md:h-6 lg:h-8 lg:w-8"
