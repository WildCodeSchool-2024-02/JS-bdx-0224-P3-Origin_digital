...
export default function registerSection() {
  return (
    <section className="w-full grid grid-cols-1 md:grid-cols-2 grid-rows-1 items-center justify-center p gap-2 md:items-start">
      <img
        src="./src/assets/images/crossfit.webp"
        alt="un coureur"
        className="img-shadow h-72 row-[1/2] ~w-64/96 max-w-[calc(100%-15px)] rounded-xl md:col-[2/3]"
      />
