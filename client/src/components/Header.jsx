...
export default function Header() {
  ...
  return (
    <header className="bg-[var(--secondaryColor)] h-20 lg:h-24 flex items-center justify-between border-b">
      <Link to="/" className="~sm/lg:~w-[150px]/[350px]">
        <img className="w-full" src={logoSrc} alt="retour à l'accueil" />
      </Link>
      <nav>
        <button
          className="space-y-2 bg-[var(--secondaryColor)] hover:bg-[var(--secondaryColor)]"
          type="button"
