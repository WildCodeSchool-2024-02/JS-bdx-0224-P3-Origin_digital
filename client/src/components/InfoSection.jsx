  ...
  return (
    <>
      <img
        ...
        alt=""
        className={`img-shadow w-[calc(90%-15px)] h-auto mx-auto max-w-[450px] rounded-xl lg:top-[-30vh] lg:ml-[8vw]  ${fadeInClass}`}
      />{" "}
        <h2
          ref={inViewRef}
          className={`text-center lg:text-left place-self-end mt-5 lg:relative lg:top-[-30vh] lg:ml-[60vw] lg:mt-[0rem]${fadeInClass}`}
        >
        ...
        <p
          ref={inViewRef}
          className={`text-center max-w-sm lg:text-left px-5 lg:relative lg:top-[-30vh] lg:ml-[60vw] lg:p-0 ${fadeInClass}`}
        >
