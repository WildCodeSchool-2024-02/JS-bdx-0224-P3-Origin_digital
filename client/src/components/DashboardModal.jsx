  ...
  return (
    <FocusLock>
      ...
      >
        ...
        focus:border-4 focus:border-green-500"
        ...
        >
          ...
          <Label className="w-full text-base">
            Catégories*
            <Select
              className="w-full relative mt-1 min-h-11 md:min-h-12"
          ...
          <Label className="w-full text-base flex flex-wrap gap-2 items-center">
            <span className="w-full">Accès</span>
            <span
              className={
